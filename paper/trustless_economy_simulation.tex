...
\author{
Anonymous Authors\thanks{Corresponding author. This paper accompanies an open-source simulation framework available at \url{https://github.com/EightRice/trustless-economy-simulation}.}
}
...
The simulation framework and all code required to reproduce these results is available as open source at \url{https://github.com/EightRice/trustless-economy-simulation}.
